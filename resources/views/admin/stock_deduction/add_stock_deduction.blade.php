        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Add Stock Deduction </h4><br><br>
                            <div class="row mt-3">
                                <div class="col-md-2">
                                    <div class="md-3">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('store.stock.deduction') }}" novalidate=""
                                ...
                                <div class="form-group mt-4">
                                    <button type="submit" class="btn btn-info" id="storeButton">Store</button>
                                </div>
                            </form>
                        </div>
                    </div>
