...
@section('admin')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('invoice.update.local') }}" novalidate="" id="invoiceForm"
                                    ...
                                    <tbody id="addRow" class="addRow">
                                        @foreach ($invoiceDetails as $details)
                                            <tr class="delete_add_more_item" id="delete_add_more_item">
                                                <input type="hidden" name="date" value="{{ $invoiceInfo->date }}">
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="sub_cat_name">{{ $details->sub_category->name ?? '' }}</span>
                                                ...
                                                <td width="8%">
                                                    <input type="digit" class="form-control size_length"
                                                        id="size_length" value="{{ $details->size_length }}"
                                                        placeholder="Length" name="size_length[]">
                                                </td>
                                                <td width="8%">
                                                    <input type="digit" class="form-control size_width" id="size_width"
                                                        placeholder="Width" value="{{ $details->size_width }}"
                                                        name="size_width[]">
                                                </td>
                                                <td width="4%" class="side">
                                                    <select name="side[]" id="side" class="form-control side">
                                                        ...
                                                        <option value="1"
                                                            {{ $details->side == '1' ? 'selected' : '' }}>One</option>
                                                    </select>
                                                </td>
                                                <td width="4%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="estimated_amount"
                                                    value="{{ $payment->total_amount }}" id="estimated_amount"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        <select class="form-control" name="paid_status" id="paid_status">
                                            ...
                                            <option value="full_paid"
                                                {{ $payment->paid_status == 'full_paid' ? 'selected' : '' }}>Full Paid
                                            </option>
                                            <option value="full_due"
                                                {{ $payment->paid_status == 'full_due' ? 'selected' : '' }}>Full Due
                                            </option>
                                            <option value="partial_paid"
                                                {{ $payment->paid_status == 'partial_paid' ? 'selected' : '' }}>Partial
                                                Paid</option>
                                        </select>
                                    ...
                                    <div class="col-md-3" id="paid_source_col" style="display: none;">
                                        <select class="form-control" name="paid_source" id="paid_source">
                                            ...
                                            <option value="cash"
                                                {{ $payment->paid_source == 'cash' ? 'selected' : '' }}>
                                                Cash</option>
    ...
    <script id="document-template" type="text/x-handlebars-template">
        <tr class="delete_add_more_item" id="delete_add_more_item">
            ...
            <td width="10%">
                <input type="digit" class="form-control unit_price text-right" required="" data-parsley-required-message="Uiit Price is required"  name="unit_price[]" value="">
            </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("keyup click change", ".unit_price,.selling_qty,.size_length,.size_width,#side",
                function() {
                    let category_name_check = $(this).closest("tr").find('.cat_name').text();
                    let subcat_name_check = $(this).closest("tr").find('.sub_cat_name').text();
                    ...
                    // let side = $(this).closest("tr").find('input.side').val();
