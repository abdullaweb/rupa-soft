...
@section('admin')
    ...
    <div class="col-md-4">
        <div class="border rounded bg-light py-2 px-2">
            ...
            <div class="fw-bold text-primary fs-5">BDT {{ number_format($billDetails->sum('total_amount')) }}/-</div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="border rounded bg-light py-2 px-2">
            <small class="text-muted">Total Paid</small>
            <div class="fw-bold text-success fs-5">BDT {{ number_format($billDetails->sum('paid_amount')) }}/-</div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="border rounded bg-light py-2 px-2">
            <small class="text-muted">Total Due</small>
            <div class="fw-bold text-danger fs-5">BDT {{ number_format($billDetails->sum('due_amount')) }}/-</div>
        </div>
    </div>
</div>
